...
import com.example.pixelsapp.databinding.BottomSheetDownloadBinding
import com.example.pixelsapp.wallpapers.framework.downloader.AndroidDownloader
...
class BottomSheetDownload(
    ...
    override fun onCreateView(
        ...
        binding = BottomSheetDownloadBinding.inflate(inflater)
        initButtons()
        return binding.root
    }
    ...
    private fun initButtons() {
        binding.run {
            ...
            setAsBackground.setOnClickListener {
                setAsBackground(HOME_SCREEN)
            }
            setAsLockscreen.setOnClickListener {
                setAsBackground(LOCK_SCREEN)
            }
        }
    }
